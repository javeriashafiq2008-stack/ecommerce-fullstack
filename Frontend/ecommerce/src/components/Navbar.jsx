            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-3 py-5 space-y-6">
                ...
                <div className="space-y-1">
                  <p className="px-3 mb-2 text-[10px] font-bold uppercase tracking-widest text-white/35">General</p>
              ...
              <div className="border-t border-white/10 px-3 py-4 space-y-1 flex-shrink-0">
                ...
                {isAuthenticated ? (
                  <>
                    ...
                    <SidebarLink to="/settings" icon={Settings} label="Settings" onNavigate={closeSidebar} />
                    <button
                      onClick={handleLogout}
